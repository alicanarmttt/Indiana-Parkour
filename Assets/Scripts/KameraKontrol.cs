...
public class KameraKontrol : MonoBehaviour
{
    ...
    void Update()
    {
        if (oyunK.oyunAktif)
        {
            ...
            kameraPos += gecisPos;
            transform.localRotation = Quaternion.AngleAxis(-kameraPos.y, Vector3.right);
            oyuncu.transform.localRotation = Quaternion.AngleAxis(kameraPos.x, oyuncu.transform.up);
        }
    }
}
